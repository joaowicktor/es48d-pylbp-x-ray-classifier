...
def main():
    ...
    trainFeatures = extractLocalBinaryPatternFeatures(trainImages)
    ...
    testFeatures = extractLocalBinaryPatternFeatures(testImages)
...
def extractLocalBinaryPatternFeatures(images):
